...
attributes for account number, account folder name, and account balance. Include methods to
deposite money, withdraw money, and display the account balance. Ensure that the account balance 
cannot be assessed directly from outside the class. Write a program to create an instance of the
